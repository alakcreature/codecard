  ...
  return (
    <>
      ...
      <div className="homepage-container">
        <Helmet>
          <meta name="title" property="og:title" content="CodeCard" />
          <meta name="type" property="og:type" content="website" />
          <meta
            name="image"
            property="og:image"
            content="https://codecard-static.sgp1.digitaloceanspaces.com/newlogo.jpg"
          />
          <meta name="url" property="og:url" content="https://codecard.in" />
          <meta
            name="description"
            property="og:description"
            content="If you are a programmer, then you might get interested to grab this amazing tool.
       From contests to practice and monitoring your progress, there are a lot more features awaits for you. Meet you soon."
          />
        </Helmet>
            ...
            <div className="home-main-content">
              ...
              <div className="rating-main">
                <div className="rating-content">
                  <div className="rating-content-bubble"></div>
                  <div className="rating-content-bubble2"></div>
              ...
              <div className="practice-main">
                <div className="practice-content">
                  <div className="practice-content-bubble"></div>
                  <div className="practice-content-bubble2"></div>
              ...
              <div className="problemsearch-main">
                <div className="problemsearch-content">
                  <div className="problemsearch-content-bubble"></div>
                  <div className="problemsearch-content-bubble2"></div>
              ...
              <div className="leaderboard-main">
                <div className="leaderboard-content">
                  <div className="leaderboard-content-bubble"></div>
                  <div className="leaderboard-content-bubble2"></div>
              ...
              <div className="collegemate-main">
                <div className="collegemate-content">
                  <div className="collegemate-content-bubble"></div>
                  <div className="collegemate-content-bubble2"></div>
              ...
              <div className="main-content-bottom">
                ...
                <p>
                  If not, then <Link to="/signin">register</Link> now to
                  kickstart your programming journey with us.
                </p>
              </div>
            </div>
                ...
                {posts.length > 0 &&
                  posts.map((post, index) => (
                    <Link
                      key={index}
                      to={{
                        pathname: `https://codecard.hashnode.dev/${post.slug}`,
                      }}
                      target="__blank"
                    >
