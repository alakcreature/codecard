...
function PrivacyPolicy() {
    ...
    return (
        <div className="container">
            <div className="container-fluid privacy-main-content ">
                <div className="privacy-main-content-inner">
                    <div className="privacy-header-section">
                        ...
                        <p>
                            ...
                            website with regards to the information that they shared and/or collect in CodeCard. This policy
                    ...
                    <div className="informationcollect-section">
                    ...
                    <div className="informationuse-section">
                    ...
                    <div className="logfiles-section">
                        <h2>Log Files</h2>

                        <p>
                            CodeCard follows a standard procedure of using log files. These files log visitors when they visit
                        ...
                        <p>
                            Like any other website, CodeCard uses 'cookies'. These cookies are used to store information 
                    ...
                    <div className="advertise-section">
                        ...
                        <p>
                            ...
                            that are used in their respective advertisements and links that appear on CodeCard, which are sent 
                        ...
                        <p>
                            Note that CodeCard has no access to or control over these cookies that are used by third-party 
                            advertisers.
                        </p>
                    </div>
                    <hr/>

                    <div className="thirdpartypolicy-section">
                        <h2>Third Party Privacy Policies</h2>

                        <p>
                            CodeCard's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising 
                    ...
                    <div className="ccpaprotectionrights-section">
                    ...
                    <div className="gdprprotectionrights-section">
                    ...
                    <div className="childreninfo-section">
                        ...
                        <p>
                            CodeCard does not knowingly collect any Personal Identifiable Information from children under the 
